...
\begin{abstract}
Les ombres sont devenues un élément important dans le réalisme de scènes de films d'animation ainsi que de jeux vidéo. Nous nous intéressons dans cette étude aux différentes techniques d'implémentation de rendu d'ombre par ordinateurs, les résultats obtenus lors de l'implémentation et les perspectives de ces derniers. Les trois principaux types d'algorithmes seront ici comparés pour déterminer les cas d'utilisation de chacun et les différences du point de vue des performances et de qualité de rendu des ombres.
\end{abstract}
