...
% Comment on met une source?? http://maverick.inria.fr/Research/RealTimeShadows/importance.html#
\end{figure}
...
\todo{Il y a deux introductions avec le même contenu à la suite l une de l autre??}
\todo{Mieux comme ça?}
