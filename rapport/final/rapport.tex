...
\todo{Ceci est une discussion par un résultat imho}C'est pour cette raison que cet algorithme est utilisé dans des logiciels d'animation nécéssitant du temps réel, comme le logiciel utilisé chez Pixar, \textit{PhotoRealistic RenderMan}.
